...
class ComplianceWorkflow:
    ...
    def __init__(
        ...
        # OCR local: Tesseract (pytesseract) + PyMuPDF, sin Azure.
        self.ocr_service = OCRService(
            provider=ocr_cfg.get("provider", "tesseract"),
            supabase_bucket=supabase_bucket,
            tesseract_lang=ocr_cfg.get("tesseract_lang", "spa+eng"),
            max_pages=ocr_cfg.get("max_pages", 4),
            zoom=ocr_cfg.get("zoom", 1.8),
            sparse_text_threshold=ocr_cfg.get("sparse_text_threshold", 140),
        )
