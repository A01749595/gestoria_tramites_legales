...
class AlertType(str, Enum):
    ...
    EXPIRATION_40_DAYS = "expiration_40_days"
    EXPIRATION_20_DAYS = "expiration_20_days"
...
class Branch(BaseModel):
    ...
    supervisor_email: Optional[EmailStr] = Field(default=None, description="Email of regional supervisor")
    director_email: Optional[EmailStr] = Field(default=None, description="Email of director")
    ...
    class Config:
        json_schema_extra = {
            "example": {
                ...
                "file_url": "s3://documents/BR-001/licencia_2024.pdf",
                "file_type": "pdf",
                "ocr_provider": "tesseract+pymupdf"
            }
        }
