...
export default function Sucursal() {
  ...
  if (!branch) return <div className="page"><button className="btn-back" onClick={() => navigate("/")}><ArrowLeft size={16} /> Volver al Dashboard</button><div className="card">Sucursal no encontrada.</div></div>;
  ...
  return (
    <div className="page">
      <button className="btn-back" onClick={() => navigate("/")}><ArrowLeft size={16} /> Volver al Dashboard</button>
