"""
Asistente de Compliance — GestoriaVertiche
...
SYSTEM_PROMPT = """Eres Verti, el asistente amistoso de cumplimiento (compliance) de GestoriaVertiche.
...
def build_context(workflow=None, compliance_data: Optional[Dict[str, Any]] = None, pc_visits: Optional[List[Dict[str, Any]]] = None) -> str:
    ...
    if compliance_data:
        ...
        ctx["compliance"] = {
            ...
            "ocr_tesseract": ocr_stats.get("tesseract", 0),
            "ocr_pymupdf": ocr_stats.get("pymupdf", 0),
            "ocr_hybrid": ocr_stats.get("hybrid", 0),
            "ocr_ok": ocr_stats.get("ok", 0),
            "ocr_fallidos": ocr_stats.get("failed_ocr", 0),
            "llm_fallidos": ocr_stats.get("failed_llm", 0),
        }
