  ...
  return (
    <div className="page">
      <div className="page-header">
        <div>
          <h1 className="page-title">Verti AI — Tu asistente de compliance</h1>
          <p className="page-sub">Consultas con IA y registro de inspecciones..</p>
        </div>
      ...
      <div className="grid-2 assistant-layout">
        <div className="card chat-card">
          ...
          <p className="td-muted" style={{ marginTop: "-6px", marginBottom: "15px", fontSize: "13px" }}>
            Resuelve dudas, consulta vigencias e inspecciones con inteligencia artificial.
          </p>
          <div className="chip-row">
            {sugerencias.map((s) => <button className="chip chip-button" key={s} onClick={() => send(s)}>{s}</button>)}
          </div>
          <div className="chat-window">
            {messages.length === 0 && <div className="empty-chat">Hola, soy Verti. Pregúntame sobre alertas, vencimientos, notificaciones o inspecciones de Protección Civil.</div>}
          ...
          <div className="chat-input-row">
            <input className="input" placeholder="Pregúntale a Verti..." value={input} onChange={(e) => setInput(e.target.value)} onKeyDown={(e) => e.key === "Enter" && send()} />
        ...
        <div className="card">
          ...
          <p className="td-muted" style={{ marginTop: "-6px", marginBottom: "15px", fontSize: "13px" }}>
            Registra las visitas de Protección Civil indicando Sucursal, Fecha, Hora y Motivo de la visita.
          </p>
